   ...
   <div id="main">
    ...
    <!--  내용보기 -->      
      <table id="board">
       ...
       <tr>
        <td colspan="4"> 
        [<a href="/BoardSp/WriteForm?menu_id=${menu_id}&bnum=0&lvl=0&step=0&nref=0">새 글 쓰기</a>]  
        [<a href="/BoardSp/WriteForm?menu_id=${menu_id}&idx=${boardVo.idx}&bnum=${boardVo.bnum}&lvl=${boardVo.lvl}&step=${boardVo.step}&nref=${boardVo.nref}">답 글 쓰기</a>]     
        [<a href="/BoardSp/UpdateForm?idx=${boardVo.idx}&menu_id=${menu_id}">수정</a>]        
        [<a href="/BoardSp/Delete?idx=${boardVo.idx}&menu_id=${menu_id}">삭제</a>]        
