...
<body> 
   <div id="main">
      ...
      <table id="PdsView">
       ...
       <tr>
         <td colspan="4"> <!--  페이징 정보 추가 -->
         [<a href="/PdsSp/List?menu_id=${map.menu_id}&nowpage=${map.nowpage}&pagecount=${map.pagecount}&pagegrpnum=${map.pagegrpnum}">목록</a>]
         [<a href="/PdsSp/WriteForm?menu_id=${map.menu_id}&bnum=0&lvl=0&step=0&nref=0"&nowpage=${map.nowpage}&pagecount=${map.pagecount}&pagegrpnum=${map.pagegrpnum}>새글 쓰기</a>]
         [<a href="/PdsSp/WriteForm?menu_id=${menu_id}&bnum=${pdsVo.bnum}&lvl=${pdsVo.lvl}&step=${pdsVo.step}&nref=${pdsVo.nref}&nowpage=${map.nowpage}&pagecount=${map.pagecount}&pagegrpnum=${map.pagegrpnum}">답글 쓰기</a>]
         [<a href="/PdsSp/UpdateForm?menu_id=${menu_id}&idx=${pdsVo.idx}&nowpage=${map.nowpage}&pagecount=${map.pagecount}&pagegrpnum=${map.pagegrpnum}">수정</a>]
         [<a href="/PdsSp/Delete?menu_id=${menu_id}&idx=${pdsVo.idx}&nowpage=${map.nowpage}&pagecount=${map.pagecount}&pagegrpnum=${map.pagegrpnum}">삭제</a>]
	     </td>     
       </tr> 
